...
\Emailtext[2]{hydikovv17914@gmail.com}
\Emailtext[3]{chdanorbis@yandex.ru}

\markboth{Д.\,А.~Григорьев, Д.\,В.~Худяков, Д.\,И.~Чернышев}{Оценка общих и специальных знаний в больших языковых моделях}
...
\alttitle{Literature summarisation with large language models}

\altauthor{D.\,A.~Grigoriev\Addressmark[a]\Emailmark[1], D.\,V.~Khudiakov\Addressmark[a]\Emailmark[2], D.\,I.~Chernyshev\Addressmark[a]\Emailmark[3]}
